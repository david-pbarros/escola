...
import br.com.dbcorp.escolaMinisterio.ui.designacao.avaliacao.DesignacoesUI;

public class AvaliacaoAction extends Action {
	private static final long serialVersionUID = 3808359432424184503L;
	
	public static final String NAME_VALUE = "Avaliar Designações";

	//Tooltip
	public static final String LONG_DESCRIPTION_VALUE = "Avaliar Designações";
	...
	public AvaliacaoAction(MainFrame mainFrame) {
