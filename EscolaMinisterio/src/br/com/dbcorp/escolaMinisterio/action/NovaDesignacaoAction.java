...
import br.com.dbcorp.escolaMinisterio.ui.designacao.nova.DesignacoesUI;

public class NovaDesignacaoAction extends Action {
	private static final long serialVersionUID = 3808359432424184503L;
	
	public static final String NAME_VALUE = "Novas Designações";

	//Tooltip
	public static final String LONG_DESCRIPTION_VALUE = "Novas Designações";
	...
	public NovaDesignacaoAction(MainFrame mainFrame) {
