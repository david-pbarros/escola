...
public class SemanaUI extends ASemanaUI {
	...
	public SemanaUI(DesignacaoGerenciador gerenciador, EstudanteGerenciador estudanteGerenciador, SemanaDesignacao semanaDesignacao, String sala, List<Estudo> estudos, List<String> ajudantesHomens, List<String> ajudantesMulheres, boolean editDetalhes) {
		this.setMinimumSize(new Dimension(631, 232));
		this.setPreferredSize(new Dimension(931, 232));
	...
	private void setFields() {
		...
		add(new JLabel("N\u00BA:"), "3, 6, center, default");
		...
		add(new JLabel("1"), "3, 8, center, default");
		...
		add(new JLabel("2"), "3, 10, center, default");
		...
		add(new JLabel("3"), "3, 12, center, default");
